...
require (
	github.com/go-kratos/kratos/contrib/registry/consul/v2 v2.0.0-20220921072156-7866ff75fd6c
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.503
